...
- Python 3.10+
- pipx (рекомендуется) или Poetry (для разработки)

### Быстрая установка через pipx (для пользователей)
...
# Установите seditor
pipx install seditor-2.0.2-py3-none-any.whl
```

После установки команда `seditor` доступна глобально:
```bash
seditor
```
